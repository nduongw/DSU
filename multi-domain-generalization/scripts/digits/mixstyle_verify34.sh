...
--output-dir output/dg/${DATASET}/${method}/verify3/${D2}_${D3}_${D4}_${D5}-${D1} \
--resume false)
...
--dataset-config-file configs/datasets/dg/${DATASET}_ms.yaml \
--config-file configs/trainers/dg/vanilla/${DATASET}.yaml \
--output-dir output/dg/${DATASET}/${method}/verify3/${D1}_${D3}_${D4}_${D5}-${D2} \
--resume false)
...
--dataset-config-file configs/datasets/dg/${DATASET}_ms.yaml \
--config-file configs/trainers/dg/vanilla/${DATASET}.yaml \
--output-dir output/dg/${DATASET}/${method}/verify3/${D2}_${D3}_${D1}_${D5}-${D4} \
--resume false)
