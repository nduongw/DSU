...
#RIDG
_C.TRAINER.RIDG = CN()
_C.TRAINER.RIDG.MOMENTUM = 0.001
_C.TRAINER.RIDG.REG = 0.01

#MetaCausal
_C.TRAINER.META_CAUSAL = CN()
_C.TRAINER.META_CAUSAL.NVALUES = 3
_C.TRAINER.META_CAUSAL.FACTOR_NUM = 16
_C.TRAINER.META_CAUSAL.RANDM = True
_C.TRAINER.META_CAUSAL.RANDN = True
_C.TRAINER.META_CAUSAL.FACTOR_NUM = 16
_C.TRAINER.META_CAUSAL.STRIDE = 10
_C.TRAINER.META_CAUSAL.LAMBDA_RE = 1
_C.TRAINER.META_CAUSAL.LAMBDA_CAUSAL = 1

#ConstStyle
_C.TRAINER.CONSTSTYLE = CN()
_C.TRAINER.CONSTSTYLE.PROB = 0.5
_C.TRAINER.CONSTSTYLE.ALPHA = 0.5
_C.TRAINER.CONSTSTYLE.TYPE = 'ver1'
_C.TRAINER.CONSTSTYLE.NUM_CONSTSTYLE = 3

#Mixstyle
_C.TRAINER.MIXSTYLE = CN()
_C.TRAINER.MIXSTYLE.PRATE = 0.5